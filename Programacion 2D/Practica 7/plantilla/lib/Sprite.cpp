...
void Sprite::draw() const
{
    ...
    float u0 = ((currentframe * frameX)) / textureX;


    float v0 = ((currentframe / getHframes()) * frameY) / textureY;


    float u1 = ((currentframe * frameX) + frameX) / textureX;



    float v1 = (((currentframe / getHframes()) + 1) * frameY) / textureY;
