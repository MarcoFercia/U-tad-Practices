...
int SetSpeedMultiplier(lua_State* L)
{
    speedpowerup = (float)lua_tonumber(L, 1);
    return 0;
}

int SetMaxLife(lua_State* L)
{
    vida = (float)lua_tonumber(L, 1);
    return 0;
}



static const struct luaL_Reg funcpacman[] =
{
...
void RegisterLuaFunctions(lua_State* L)
{
    ...
    luaL_register(L, "functions_pacman",funcpacman);
}
